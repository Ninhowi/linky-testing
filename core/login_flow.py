"""
Shared login flow logic. Used by automation tests (Excel data) and manual tests (user input).
"""
...
def run_login_flow(driver, wait, waitAuth, email, password, otp, message):
    email = email or ''
